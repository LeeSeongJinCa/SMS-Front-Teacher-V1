...
export const tutorials: Tutorial[] = [
  ...
  },
  {
    texts: [
      ...
      "지킴이 선생님이 외출을 나갈 수 있는 학생을 판단하기 쉽도록 만들었어요."
    ],
    top: "280px",
    left: "calc(30vw + 15px)",
    page: "/out/approved",
  ...
  },
  {
    texts: [
      "현재 외출 중인 외출증을 보여줘요.",
      "학생이 외출을 시작하면 이곳에 표시돼요.",
      "외출을 마친 학생은 선생님께 직접 찾아가 외출증을 종료해야 해요.",
      "담임 선생님 외의 선생님이 했다면 담임 선생님에게 학생이 종료했다고 문자가 발송돼요!",
      "담임 선생님이 아니더라도 걱정말고 종료할 수 있어요."
    ],
    top: "335px",
    left: "calc(30vw + 15px)",
    page: "/out/now",
  ...
  },
  {
    texts: [
      "종료한 외출증을 보여줘요.",
      "최종 확인을 대기 중인 외출증이 표시돼요.",
      "외출이 종료된 외출증은 바로 '종료된 외출증'으로 이동하지 않고 현재 단계를 거쳐요.",
      "외출 종료는 담임 선생님 외에도 다른 선생님도 할 수 있어요.",
      "때문에 담임 선생님이 반 학생의 외출증을 확인하지 못 할 수도 있어요.",
      "'최종 확인 대기 외출증'은 꼭 담임 선생님께서 확인을 해주세요."
    ],
    top: "390px",
    left: "calc(30vw + 15px)",
    page: "/out/done",
  ...
  },
  {
    texts: [
      "외출 통계를 보여줘요.",
      "종료된 외출증을 바탕으로 학번, 이름, 외출 횟수, 지각 횟수를 간략하게 보여줘요.",
      "학생을 클릭하면 학생이 외출할 때 입력했던 장소, 사유, 날짜, 도착시간, 상태, 지각 여부도 보여줘요.",
      "또, 학년, 반, 이름, 기간을 정해 특정한 외출증을 볼 수도 있어요."
    ],
    top: "500px",
    left: "calc(30vw + 15px)",
    page: "/out/statistics",
  ...
  },
  {
    texts: [
      "새로운 외출이 신청 됐어요.",
      "하지만 매번 페이지를 새로고침 하는 시간이 아까워요.",
      "그래서 해당 외출증만 다시 받아올 수 있는 외출증 새로 고침을 만들었어요.",
      "우리 시간은 한정되어 있으니 아껴써요!"
    ],
    top: "135px",
    left: "calc(30vw + 15px + 5px)",
    page: "/out/wait",
    bubbler: {
      width: "0 15px 15px",
      top: "-15px;",
  ...
  },
  {
    texts: [
      ...
      "필터가 적용되면 학년, 반 혹은 층으로 조건을 설정할 수 있어요.",
  ...
  },
  {
    texts: [
      ...
      "또, 외출증 조건에 따라 외출증을 클릭 했을 때 뜨는 화면이 달라져요.",
      "승인대기 외출증 페이지는 승인 혹은 거절할 수 있는 창이 떠요.",
      "현재 외출 학생 페이지는 외출을 종료할 수 있는 창이 떠요.",
      "최종 확인 대기 외출증 페이지는 확인하는 확인하는 창이 떠요.",
      "이 3개 외의 부분에서는 외출증을 클릭해도 아무런 변화가 없어요."
    ],
    top: "360px",
    left: "50px",
    page: "/out/wait",
