...
export const SET_OUTING_CARD_LIST = "outingCard/SET_OUTING_CARD_LIST" as const;
...
export const FINISH_OUTING_CARD_SAGA = "outingCard/FINISH_OUTING_CARD_SAGA" as const;
export const TEACHER_FINISH_OUTING_CARD_SAGA = "outingCard/TEACHER_FINISH_OUTING_CARD_SAGA" as const;

export const teacherFinishOutingCardSaga = (uuid: string) => ({
  type: TEACHER_FINISH_OUTING_CARD_SAGA,
  payload: uuid
});
export const finishOutingCardSaga = (uuid: string) => ({
  type: FINISH_OUTING_CARD_SAGA,
  payload: uuid
});
...
export type OutingCardAction =
  | ReturnType<typeof setOutingCardList>
